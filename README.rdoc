...
you have as fair notion about Redline. In short, Redline defines _lines_, 
or _tracks_, within which all Redline services run. The developer only needs
to define service instances or _tasks_, as YAML and Ruby configuration files
in a project's Redfile or task/*.redfile files. For example, Redline's RubyForge
