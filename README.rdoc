...
you have as fair notion of Syckle. In short, Syckle defines life-cycles
within which all Syckle services run. You define serivce instances, or
tasks, as YAML configuration files in you projects +task+ directory with
a .syckle extension, eg. +box.syckle+, or in a central +Syckfile+. For example,
...
Actually, this is not longer used becuase Syckle moved to GitHub, but this
...
but it helps ensure a project is always up-to-date and in-sync. Syckle
...
Please see http://proutils.github.com/syckle for more details on how to
...
We no longer recommend it, byt Syckle can also be installed the
...
All in all, Syckle works well. There are some rough edges with regards
...
and give Syckle a try please let us know of any issues you encounter.


== HISTORY

Syckle is actaully the offspring of Reap v10, and represents
